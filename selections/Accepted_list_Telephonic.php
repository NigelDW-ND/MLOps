...
if($GETstatResult['PercentAnsw'] == 100){}else{
				echo "<tr>
					<td>".$row['entname']."</td>
					<td>".$row['firstname']."</td>
					<td>".$row['lastname']."</td>
					...
					<button  class="clk_comment_alt" onclick="window.location.href='Particants_interview_page.php?business_key=<? echo $row['id_signupdate'] ?>'">Interview</button>
					<?	
					} 
					 echo "</td>
					</tr>";
